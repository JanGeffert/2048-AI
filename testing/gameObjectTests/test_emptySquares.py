...
def test_2_emptySquares():
	boardTest = Board(XDIM, YDIM, config=config2)
	assert boardTest.emptySquares() == config2Free

def test_3_emptySquares():
	boardTest = Board(XDIM, YDIM, config=config3)
